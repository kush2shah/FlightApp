...
class FlightViewModel: ObservableObject {
    ...
    private func formatTimeWithZone(actual: String?, estimated: String?, scheduled: String?, timezone: String, departureDelay: Int? = nil, arrivalDelay: Int? = nil, isCancelled: Bool = false) -> FlightTime {
            ...
            if let departureDelay = departureDelay, departureDelay > 0 {
                isDelayed = true
