...
paths:
  ...
  /foresight/flights/search/advanced:
    get:
      ...
      responses:
        ...
        '400':
          description: |
            Incorrect parameter(s). Query may be incorrect.
          content:
            application/json; charset=UTF-8:
              schema:
                title: Error
  ...
  '/foresight/flights/{id}/position':
    get:
      ...
      responses:
        ...
        '400':
          description: |
            Incorrect parameter (id). Id may be missing or may not be fa_flight_id format. Query may be incorrect.
          content:
            application/json; charset=UTF-8:
              schema:
                title: Error
                    ...
                    items:
                      ...
                      properties:
                        code:
                          type: string
                          description: |
                            ICAO identifier if known, otherwise IATA or LID. For position-only
  ...
  /airports/nearby:
    get:
      ...
      responses:
                        ...
                        - type: object
                          properties:
                            ...
                            state:
                              type: string
                              description: |
                                State/province where the airport resides if applicable. For US states
        ...
        '400':
          description: |
            Incorrect parameter(s). Expected: numerical latitude and longitude, radius > 0.
          content:
            application/json; charset=UTF-8:
              schema:
                title: Error
                    ...
                    items:
                      ...
                      properties:
                        ...
                        color:
                          type: string
                          description: |
                            Color of largest delay. Red when delay is geater than 1 hour. Yellow when
                        ...
                        delay_secs:
                          type: integer
                          description: |
                            Duration of largest delay (seconds). This value is not intended to be
                          ...
                          items:
                            ...
                            properties:
                              ...
                              delay_secs:
                                type: integer
                                description: |
                                  Duration of delay (seconds). This value is not intended to be
                                  presented to users and should only be used for sorting results.
                              reason:
                                type: string
    ...
    get:
      ...
      parameters:
        - name: id
          in: path
          description: |
            ICAO, IATA or LID ID of destination airport to fetch. [ICAO is highly preferred](/aeroapi/portal/resources#icaoCode) to prevent ambiguity.
          required: true
          schema:
            type: string
          examples:
      ...
      responses:
        ...
        '400':
          description: |
            Incorrect parameter (id). Id must be a valid airport code and cannot be empty.
          content:
            application/json; charset=UTF-8:
              schema:
                title: Error
  ...
  '/airports/{id}/canonical':
    get:
      ...
      responses:
                    ...
                    items:
                      ...
                      properties:
                        id:
                          type: string
                          description: |
                            Canonical airport code. This is the code by which a given airport (and
        ...
        '400':
          description: |
            Incorrect parameter(s). Id must be a valid airport code and id_type must be 'icao', 'iata', or 'lid'.
          content:
            application/json; charset=UTF-8:
              schema:
                title: Error
  ...
  '/airports/{id}/nearby':
    get:
      ...
      responses:
        ...
        '400':
          description: |
            Incorrect parameter(s). Id must be a valid airport code and cannot be empty, radius > 0.
          content:
            application/json; charset=UTF-8:
              schema:
                title: Error
  ...
  '/airports/{id}/flights':
    get:
      ...
      responses:
        ...
        '400':
          description: |
            Incorrect parameter (id). Id must be a valid airport code and cannot be empty. Airline and type query params cannot both be set.
          content:
            application/json; charset=UTF-8:
              schema:
                title: Error
  ...
  '/airports/{id}/flights/arrivals':
    get:
      ...
      responses:
        ...
        '400':
          description: |
            Incorrect parameter(s). Id must be a valid airport code and cannot be empty. Airline and type query params cannot both be set.
          content:
            application/json; charset=UTF-8:
              schema:
                title: Error
    ...
    get:
      ...
      parameters:
        ...
        - name: connection
          in: query
          description: |
            Whether flights should be filtered based on their connection status. If setting
      ...
      responses:
        ...
        '400':
          description: |
            Incorrect parameter(s). Id and dest_id must be valid airport codes and cannot be empty.
          content:
            application/json; charset=UTF-8:
              schema:
                title: Error
              ...
              schema:
                ...
                properties:
                  departed:
                    ...
                    minimum: 0
                    description: |
                      Number of flights that have departed the airport and are currently
                      airborne.
                  enroute:
                    type: integer
                    minimum: 0
                  ...
                  scheduled_arrivals:
                    ...
                    minimum: 0
                    description: |
                      Number of flights that have not yet departed but are scheduled to arrive
                      at the airport.
                  scheduled_departures:
                    type: integer
                    minimum: 0
  ...
  '/airports/{id}/weather/observations':
    get:
      ...
      responses:
                    ...
                    items:
                      ...
                      properties:
                        airport_code:
                          type: string
                          description: |
                            The airport code of the report. LID/IATA will be used if airport lacks an
                            ICAO code.
                        cloud_friendly:
                          type: string
                          nullable: true
        ...
        '400':
          description: |
            Incorrect parameter (id). Id must be a valid airport code and cannot be empty. Temperature_units may be invalid. Timestamp may be before user's history limit.
          content:
            application/json; charset=UTF-8:
              schema:
                title: Error
  ...
  '/airports/{id}/weather/forecast':
    get:
      ...
      responses:
                              ...
                              items:
                                ...
                                properties:
                                  ...
                                  coverage:
                                    ...
                                    nullable: true
                                    description: |
                                      Area of sky covered by the cloud layer (few 0-2 octas, scatterd
                                  ...
                                  special:
                                    ...
                                    nullable: true
                                    description: |
                                      Any special modifiers such as CB (cumulonimbus) or TCU
        ...
        '404':
          description: |
            No upcoming forecast currently available for this airport.
          content:
            application/json; charset=UTF-8:
              schema:
                title: Error
  ...
  '/airports/{id}/routes/{dest_id}':
    get:
      ...
      responses:
        ...
        '400':
          description: |
            Incorrect parameter(s). Id and dest_id must be valid airport codes and cannot be empty. Max_file_age must be one of the specified values.
          content:
            application/json; charset=UTF-8:
              schema:
                title: Error
                  ...
                  - type: object
                    properties:
                      ...
                      callsign:
                        ...
                        nullable: true
                        description: |
                          The operator's ICAO telephony name (callsign) used with air traffic
                          control.
                      name:
                        type: string
                      ...
                      location:
                        ...
                        nullable: true
                        description: |
                          Potentially a more specific location where the operator is based. May
                      ...
                      shortname:
                        ...
                        nullable: true
                        description: |
                          Shorter version of the operator's name. Typically the "doing business as"
              ...
              schema:
                ...
                properties:
                  ...
                  flights_last_24_hours:
                    ...
                    minimum: 0
                    description: |
                      The number of flights departed in the last 24 hours for this operator,
  ...
  /alerts:
    get:
      ...
      parameters:
        - in: query
          name: max_pages
          description: |
            Maximum number of pages to fetch. This is an upper limit and not
                        ...
                        - type: object
                          properties:
                            ...
                            description:
                              type: string
                              description: |
                                Server-generated textual description of alert. May include carrier,
                        ...
                        - type: object
                          properties:
                            ident:
                              ...
                              nullable: true
                              description: |
                                Ident to alert on. This value may be modified based on codeshare
                        ...
                        - type: object
                          properties:
                            start:
                              ...
                              format: date
                              description: |
                                Start date of alert. Should be in departure airport's
                                timezone.
                            end:
                              type: string
                              nullable: true
                              format: date
                              description: |
                                End date of alert (inclusive). Should be in departure airport's
                                timezone.
                        - type: object
                          properties:
                            user_ident:
                        ...
                        - type: object
                          properties:
                            eta:
                              type: integer
                              description: |
                                How many minutes before a flight's ETA that an alert should be
                            ...
                            impending_departure:
                              ...
                              items:
                                type: integer
                              description: |
                                List of minutes before a flight's departure time that alerts should be delivered.
                            ...
                            events:
                              ...
                              properties:
                                arrival:
                                  type: boolean
                                  description: |
                                    Whether alerts should be delivered on arrival. FlightAware
                                ...
                                departure:
                                  type: boolean
                                  description: |
                                    Whether alerts should be delivered on departure. FlightAware
                                ...
                                hold_end:
                                  type: boolean
                                  description: |
                                    Whether alerts should be delivered on end datetime of hold exit
                            ...
                            target_url:
                              ...
                              nullable: true
                              description: |
                                Alert specific URL to deliver to. If null, then the alert
    ...
    post:
                ...
                - type: object
                  properties:
                    max_weekly:
                      type: integer
                      description: |
                        Reject the new alert if the estimated number of triggered alerts
      ...
      responses:
        ...
        '400':
          description: |
            Invalid parameters specified (invalid ident, origin, destination, aircraft_type, dates or missing events) or alert configured would trigger more
  ...
  '/alerts/{id}':
    ...
    put:
      ...
      responses:
        ...
        '400':
          description: |
            Invalid parameters specified (invalid ident, origin, destination, aircraft_type, dates or missing events) or alert configured would trigger more than max_weekly delivered alerts per week.
          content:
            application/json; charset=UTF-8:
              schema:
                title: Error
  ...
  /alerts/endpoint:
    get:
      ...
      summary: Get configured alert callback URL
      description: |
          ...
          content:
            application/json; charset=UTF-8:
              schema:
                type: object
                description: |
                  Configuration for a URL to which AeroAPI alerts should be delivered via HTTP POST.
    ...
    put:
      ...
      summary: Set alert callback URL
      description: |
                        ...
                        flight:
                          ...
                          properties:
                            ...
                            ident:
                              type: string
                              description: |
                                Either the operator code (ICAO or IATA) followed by the flight number for the flight
                            ...
                            ident_icao:
                              ...
                              nullable: true
                              description: |
                                The ICAO operator code followed by the flight number for the flight.
                            ident_iata:
                              type: string
                              nullable: true
                              description: |
                                The IATA operator code followed by the flight number for the flight.
                            registration:
                              type: string
                              nullable: true
                              description: |
                            ...
                            atc_ident:
                              ...
                              nullable: true
                              description: |
                                Alternate ident for flight, possibly assigned by ATC.
                            aircraft_type:
                              type: string
                              description: |
                                Aircraft type will generally be ICAO code, but
                            ...
                            origin:
                              ...
                              nullable: true
                              description: |
                                The ICAO, IATA, or LID identifier for the origin airport
                            origin_icao:
                              type: string
                              nullable: true
                              description: |
                                The ICAO identifier for the origin airport
                            origin_iata:
                              type: string
                              nullable: true
                              description: |
                                The IATA identifier for the origin airport
                            origin_lid:
                              type: string
                              nullable: true
                              description: |
                                The LID identifier for the origin airport
                            destination:
                              type: string
                              nullable: true
                              description: |
                                The ICAO, IATA, or LID identifier for the destination airport
                            destination_icao:
                              type: string
                              nullable: true
                              description: |
                                The ICAO identifier for the destination airport
                            destination_iata:
                              type: string
                              nullable: true
                              description: |
                                The IATA identifier for the destination airport
                            destination_lid:
                              type: string
                              nullable: true
                              description: |
                                The LID identifier for the destination airport
                            route:
                              type: string
                              nullable: true
                              description: |
                            ...
                            cancelled:
                              type: boolean
                              description: |
                                Flag indicating whether this flight was cancelled.
                            diverted:
                              type: boolean
                              description: |
                                Flag indicating whether this flight was diverted.
                            ...
                            error:
                              type: string
                              description: |
                                Will contain error information in the event that
    ...
    delete:
      ...
      summary: Remove and disable default account-wide alert callback URL
      description: |
  ...
  '/history/flights/{ident}':
    get:
      ...
      responses:
        ...
        '400':
          description: |
            Incorrect parameter(s). Ident may be missing or not in fa_flight_id format or max_pages may be < 1. Request may be for data before earliest date or more than a 7 day span of results was requested.
          content:
            application/json; charset=UTF-8:
              schema:
                title: Error
  ...
  '/history/flights/{id}/track':
    get:
      ...
      summary: Get historical information for a flight's track
      description: |
      ...
      parameters:
        ...
        - name: include_surface_positions
          in: query
          description: |
            Whether to include surface positions in the flight track and
      ...
      responses:
        ...
        '400':
          description: |
            Incorrect parameter(s). Id parameter may not be fa_flight_id format.
          content:
            application/json; charset=UTF-8:
              schema:
                title: Error
  ...
  '/history/flights/{id}/map':
    get:
      ...
      summary: Get an image of a historical flight's track on a map
      description: |
  ...
  '/history/flights/{id}/route':
    get:
      ...
      summary: Get historical flight's filed route
      description: |
  ...
  '/history/aircraft/{registration}/last_flight':
    get:
      ...
      summary: Get aircraft's last known flight
      description: |
      ...
      responses:
        ...
        '400':
          description: |
            Incorrect parameter. Registration parameter may be missing or not the correct format.
          content:
            application/json; charset=UTF-8:
              schema:
                title: Error
  ...
  '/aircraft/{ident}/blocked':
    ...
    get:
      ...
      summary: Check if a given ident is blocked
      description: |
      ...
      responses:
        ...
        '400':
          description: |
            Incorrect parameter(s). Ident may be missing.
          content:
            application/json; charset=UTF-8:
              schema:
                title: Error
  ...
  '/aircraft/{ident}/owner':
    ...
    get:
      ...
      summary: Get the owner of an aircraft
      description: |
      ...
      responses:
        ...
        '400':
          description: |
            Incorrect or missing ident. It should be a flight number or a tail number.
          content:
            application/json; charset=UTF-8:
              schema:
                title: Error
  ...
  '/aircraft/types/{type}':
    ...
    get:
      ...
      summary: Get information about an aircraft type
      description: |
      ...
      responses:
        ...
        '400':
          description: |
            Incorrect parameters. Type must be an ICAO aircraft type designator string.
          content:
            application/json; charset=UTF-8:
              schema:
                title: Error
  ...
  '/schedules/{date_start}/{date_end}':
    parameters:
      - in: path
        name: date_start
        description: |
          Datetime or date of earliest scheduled flight departure to return. This
      ...
      - in: path
        name: date_end
        description: |
          Datetime or date of latest scheduled flight departure to return. This must
      ...
      - in: query
        name: origin
        description: |
          Only return flights with this origin airport. ICAO or IATA airport codes
          can be provided.
        schema:
          type: string
        examples:
      ...
      - in: query
        name: destination
        description: |
          Only return flights with this destination airport. ICAO or IATA airport codes
          can be provided.
        schema:
          type: string
        examples:
      ...
      - in: query
        name: airline
        description: |
          Only return flights flown by this carrier. ICAO or IATA carrier codes
          can be provided.
        schema:
          type: string
        examples:
    ...
    get:
      ...
      responses:
                ...
                properties:
                  ...
                  scheduled:
                    ...
                    items:
                      type: object
                      description: |
                        Information for a scheduled flight. All data is sourced from operator's
                        schedule and may not reflect actual flight information (even after the
                        flight has occurred).
                      properties:
                        ident:
                          type: string
                        ...
                        fa_flight_id:
                          ...
                          nullable: true
                          description: |
                            Unique FlightAware ID for flight. Will be null for flights
        ...
        '400':
          description: |
            Incorrect parameter(s). Date_start and date_end must be within time constraints and ISO 8601 format (ex. 1970-01-01T00:00:00Z). Airline and flight_number, if present, must be valid.
          content:
            application/json; charset=UTF-8:
              schema:
                title: Error
  ...
  '/disruption_counts/{entity_type}':
    ...
    get:
      ...
      summary: Get global flight disruption statistics
      description: |
      ...
      responses:
                    ...
                    items:
                      ...
                      properties:
                        ...
                        total:
                          ...
                          minimum: 0
                          description: |
                            Total number of originally scheduled flights for this airline or
                            airport.
                        entity_name:
                          type: string
                          nullable: true
        ...
        '400':
          description: |
            Incorrect parameters. Entity_type and time_period must be one of the specified values. Entity_type cannot be empty.
          content:
            application/json; charset=UTF-8:
              schema:
                title: Error
  ...
  '/disruption_counts/{entity_type}/{id}':
    parameters:
      - in: path
        ...
        required: true
        description: |
          The ICAO code for the airline or ID for the airport (ICAO, IATA, or LID)
    ...
    get:
      ...
      summary: Get flight disruption statistics for a particular entity
      description: |
      ...
      responses:
        ...
        '400':
          description: |
            Incorrect parameters. Entity_type and time_period must be one of the specified values. Entity_type cannot be empty. id must be a valid operator or airport code.
          content:
            application/json; charset=UTF-8:
              schema:
                title: Error
    ...
    get:
      ...
      parameters:
        - in: query
          name: start
          description: |
            Datetime or date to start gathering usage data from. If left blank,
        ...
        - in: query
          name: end
          description: |
            Datetime or date to end gathering usage data from. If left blank,
              ...
              schema:
                ...
                properties:
                  ...
                  total_cost:
                    type: number
                    description: |
                      Total cost for all calls made across all resources.
                      Does not include volume discounting
                  total_discount_cost:
                    type: number
                    description: |
                      Total cost across all resources including volume discounting.
                    ...
                    items:
                      ...
                      properties:
                        ...
                        resource_cost:
                          type: number
                          description: |
                            Total cost for all calls made to this resource.
                            Does not include volume discounting
